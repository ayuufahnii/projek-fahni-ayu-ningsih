        ...
        <div className="grid md:grid-cols-2 gap-10 items-center">
          ...
          >
            <div className="relative">
              ...
              {/* glow background */}
              <div className="absolute inset-0 rounded-2xl bg-gradient-to-tr from-primary/30 to-purple-500/30 blur-2xl -z-10"></div>
            </div>
          </motion.div>
          ...
          <div className="text-center md:text-left">
            ...
            <motion.div
              ...
              className="flex flex-col sm:flex-row md:justify-start justify-center items-center gap-4 mb-12"
            >
              <Button
                size="lg"
